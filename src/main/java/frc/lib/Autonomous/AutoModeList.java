...
public class AutoModeList {
  ...
  private ArrayList<String> orderedModeNameList =
      new ArrayList<
          String>(); // Helps keep track of the order the modes were added in, to ensure they end up
  // ordered that same way in the web UI.
