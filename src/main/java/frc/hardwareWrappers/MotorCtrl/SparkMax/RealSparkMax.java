...
public class RealSparkMax extends AbstractSimmableMotorController {
    ...
    while (!success) {
      ...
      var err2 =
          m_motor.setPeriodicFramePeriod(
              PeriodicFrame.kStatus0, 19); // Status 0 = Motor output and Faults
      var err3 =
          m_motor.setPeriodicFramePeriod(
              PeriodicFrame.kStatus1, 57); // Status 1 = Motor velocity & electrical data
      var err4 =
          m_motor.setPeriodicFramePeriod(
              PeriodicFrame.kStatus2, 65500); // Status 2 = Motor Position
      var err5 =
          m_motor.setPeriodicFramePeriod(
              PeriodicFrame.kStatus3, 65500); // Status 3 = Analog Sensor Input
      var err6 = m_motor.setSmartCurrentLimit(40); // 40 A current limit
      success =
          (err0 == REVLibError.kOk
  ...
  public void setClosedLoopCmd(double velocityCmd_radpersec, double arbFF_V) {
    ...
    m_pidController.setReference(
        Units.radiansPerSecondToRotationsPerMinute(velocityCmd_radpersec),
  ...
  public void follow(Object leader) {
    if (leader.getClass() == RealSparkMax.class) {
      ...
      throw new IllegalArgumentException(
          leader.getClass().toString() + " cannot be followed by a " + this.getClass().toString());
    }
  }
